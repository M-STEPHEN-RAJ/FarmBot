      ...
      <div className="bg-white w-1/2 h-full flex flex-col justify-center items-center">
        ...
        <div className="space-y-8 min-w-[450px]">
          ...
          <div className="space-y-5">
            <div onClick={handleGoogleSignIn} className="flex justify-center items-center gap-5 rounded-md py-2.5 border border-gray-300 cursor-pointer">
          ...
          <div className="space-y-5 -mt-3">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input 
                ...
                onChange={handleChange}
              />
              <p className='text-right text-sm text-[#166831] font-semibold cursor-pointer mt-1'>Forgot Password?</p>
            </div>

          </div>

          <div className="space-y-4">
            <button onClick={handleLogin} className='w-full bg-[#166831] font-medium text-white py-1.5 rounded-md cursor-pointer'>
              Login
            </button>

            <p className='text-sm text-center'>Don't have an account? <span onClick={handleRegisterRedirect} className='text-[#166831] font-semibold cursor-pointer'>Register</span></p>
          </div>
