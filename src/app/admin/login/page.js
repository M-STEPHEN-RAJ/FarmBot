...
const AdminLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        localStorage.setItem("admin-session-change", Date.now());
  ...
  return (
    <>
      ...
      <div className="flex w-screen h-screen overflow-hidden">
          ...
          <div className="space-y-8 min-w-[450px]">
            ...
            <div className="space-y-5 mt-12">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                />
                {/* <p className="text-right text-sm text-[#6A1B9A] font-semibold cursor-pointer mt-1">
                  Forgot Password?
                </p> */}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <button
                onClick={handleLogin}
                className="w-full bg-[#6A1B9A] font-medium text-white py-1.5 rounded-md cursor-pointer"
              >
                Login
              </button>             
            </div>
        ...
        {/* Right Theme */}
        <div className="relative w-1/2 h-full bg-[#a955f742]">
          <div className="absolute top-0 -left-0.5">
            <img
              src="/images/admin/login/login-1.png"
              alt=""
          ...
          <div className="absolute -bottom-6.5 right-0">
            <img
              src="/images/admin/login/login-2.png"
              alt=""
          ...
          <div className="flex items-center absolute top-5 right-5">
            ...
            />
            <h2 className="text-[#6A1B9A] text-xl font-semibold">FarmBot</h2>
          </div>

          <div className="relative w-full h-full z-10">
            <div className="w-full h-full flex flex-col justify-center items-center -mt-7">
              <img
                src="/images/admin/login/login-bg.png"
                alt=""
              ...
              <div className="flex flex-col justify-center items-center gap-5">
                ...
                <p className="w-[70%] text-base text-[#6A1B9A] text-center">
