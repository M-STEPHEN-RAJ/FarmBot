    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white px-6 py-5 rounded-xl w-full max-w-sm space-y-5">
        ...
        <div className="flex justify-between items-center">
          <h3 className="text-md font-medium">Delete Recommendation</h3>
          <div
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            disabled={loading}
            className={`w-20 px-4 py-1.5 text-sm rounded-md flex justify-center items-center gap-2 cursor-pointer
              ${loading
