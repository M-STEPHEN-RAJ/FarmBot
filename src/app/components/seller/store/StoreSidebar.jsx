  ...
  return (
    <div className="w-[280px] h-screen overflow-y-auto space-y-4 pb-5 border-r border-gray-300">
            ...
            <button
              ...
              className={`px-4 py-[3px] rounded-md text-sm font-medium transition-colors cursor-pointer ${
                selectedCategory === cat
                  ...
                  : "text-[#EB3D3F] hover:bg-red-50 border border-[#EB3D3F]"
              }`}
            >
              {cat}
            </button>
      ...
      <div className="px-2">
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-full h-2">
            ...
            <div
              ref={range}
              className="absolute top-1/2 -translate-y-1/2 h-1 bg-[#EB3D3F] rounded"
              style={{
                left: `${getPercent(min)}%`,
      ...
      <div className="flex justify-center mt-8">
        <button
          onClick={handleReset}
          className="w-1/2 p-1 text-sm font-medium text-red-700 border border-red-700 hover:text-white hover:bg-red-700 rounded-full cursor-pointer"
        >
          Reset
        </button>
      </div>
