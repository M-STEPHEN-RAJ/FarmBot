  ...
  return (
    <div className="w-[280px] h-screen overflow-y-auto space-y-4 py-4 border-r border-gray-300">
            ...
            <button
              ...
              className={`px-4 py-[3px] rounded-md text-sm font-medium transition-colors cursor-pointer ${
                selectedCategory === cat
                  ...
                  : "text-[#6A1B9A] hover:bg-green-50 border border-[#6A1B9A]"
              }`}
            >
              {cat}
            </button>
      ...
      <div className="px-2">
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-full h-2">
            ...
            <div
              ref={range}
              className="absolute top-1/2 -translate-y-1/2 h-1 bg-[#6A1B9A] rounded"
              style={{
                left: `${getPercent(min)}%`,
            ...
            <input
              ...
              [&::-webkit-slider-thumb]:bg-[#6A1B9A]
              [&::-webkit-slider-thumb]:rounded-full
              [&::-webkit-slider-thumb]:appearance
      ...
      <div className="flex justify-center mt-8">
        <button
          onClick={handleReset}
          className="w-1/2 p-1 text-sm font-medium text-[#6A1B9A] border border-[#6A1B9A] hover:bg-[#6A1B9A] rounded-full cursor-pointer"
        >
          Reset
        </button>
      </div>
